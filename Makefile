...
migrate:
	docker-compose -f docker-compose.yml run --rm proyecto-laravel-backend /entrypoint.sh run-migrations

tests:
	docker-compose -f docker-compose.tests.yml run --rm proyecto-laravel-tests /entrypoint.sh run-tests
...
bash:
	docker-compose -f docker-compose.yml run --rm proyecto-laravel-backend bash
